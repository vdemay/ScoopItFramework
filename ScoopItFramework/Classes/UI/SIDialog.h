...
@protocol SIDialogDelegate;

BOOL IsDeviceIPad();

@interface SIDialog : UIView <UIWebViewDelegate> {
  id<SIDialogDelegate> _delegate;
  NSURL* _loadingURL;
  UIWebView* _webView;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<SIDialogDelegate> delegate;
...
@protocol SIDialogDelegate <NSObject>
